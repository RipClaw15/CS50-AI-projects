...
| **[Heredity](https://github.com/RipClaw15/CS50-AI-projects/tree/main/week2/heredity)** | Bayesian Inference (Exhaustive Enumeration) | **Python (Standard Library only)** | Brute-force calculates posterior genetic probabilities across all possible family trait combinations—**built entirely without external ML libraries** |
